...
/**
 * @extends ServiceEntityRepository<ConcertFixtures>
 *
...
//    /**
//     * @return ConcertFixtures[] Returns an array of ConcertFixtures objects
//     */
...
//    public function findOneBySomeField($value): ?ConcertFixtures
//    {
//        return $this->createQueryBuilder('c')
//            ->andWhere('c.exampleField = :val')
//            ->setParameter('val', $value)
