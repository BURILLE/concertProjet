...
/**
 * @extends ServiceEntityRepository<TagsFixtures>
 *
...
//    /**
//     * @return TagsFixtures[] Returns an array of TagsFixtures objects
//     */
...
//    public function findOneBySomeField($value): ?TagsFixtures
//    {
//        return $this->createQueryBuilder('t')
//            ->andWhere('t.exampleField = :val')
//            ->setParameter('val', $value)
